export const PREFECTURE_LIST = [
  ...
  { code: 3, name: "Bắc Giang" },
  { code: 4, name: "Bắc Kạn" },
  { code: 5, name: "Bạc Liêu" },
  { code: 6, name: "Bắc Ninh" },
  { code: 7, name: "Bến Tre" },
  { code: 8, name: "Bình Định" },
  { code: 9, name: "Bình Dương" },
  { code: 10, name: "Bình Phước" },
  { code: 11, name: "Bình Thuận" },
  { code: 12, name: "Cà Mau" },
  { code: 13, name: "Cần Thơ" },
  { code: 14, name: "Cao Bằng" },
  { code: 15, name: "Đà Nẵng" },
  { code: 16, name: "Đắk Lắk" },
  { code: 17, name: "Đắk Nông" },
  { code: 18, name: "Điện Biên" },
  { code: 19, name: "Đồng Nai" },
  { code: 20, name: "Đồng Tháp" },
  ...
  { code: 58, name: "Thành phố Hồ Chí Minh" },
